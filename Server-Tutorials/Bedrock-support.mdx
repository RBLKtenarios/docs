...
icon: "globe"
description: "Looking to let your **Bedrock Edition players** join your **Java Edition Minecraft server**? Whether you're a server owner or a hosting provider, enabling **crossplay support** using **GeyserMC** and **Floodgate** is the most reliable solution in 2025.
