...
<meta name="description" content="Want Bedrock players on your Java Minecraft server? This 2025 guide shows you how to use GeyserMC and Floodgate for seamless Java-Bedrock crossplay.">
<meta name="keywords" content="Minecraft crossplay server, Java Bedrock compatibility, GeyserMC tutorial 2025, Install Geyser plugin, Floodgate setup, Minecraft Java Bedrock support">
```
